...
void printTime(Time t) {
  ...
  char buf[50];
  snprintf(buf, sizeof(buf), "(%d) %s %02d/%02d/%04d %02d:%02d:%02d",
           t.day, dayAsString(t.day),
           t.date, t.mon, t.yr,
           t.hr, t.min, t.sec);
...
String timeToString(Time t) {
  char buf[50];
  snprintf(buf, sizeof(buf), "%02d/%02d/%04d %02d:%02d:%02d", t.date, t.mon, t.yr, t.hr, t.min, t.sec);
  return String(buf);
}